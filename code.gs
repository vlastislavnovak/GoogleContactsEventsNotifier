...
var i18n = {
  ...
  'cs': {
    ...
    'Years': 'let',
    'Events': 'Události',
    'Birthdays today': 'Dnešní narozeniny',
    'Birthdays tomorrow': 'Zítřejší narozeniny',
    'Birthdays in {0} days': 'Narozeniny za {0} dní',
    'Anniversaries today': 'Dnešní výročí',
    'Anniversaries tomorrow': 'Zítřejší výročí',
    'Anniversaries in {0} days': 'Výročí za {0} dní',
    'Custom events today': 'Jiné dnešní události',
    'Custom events tomorrow': 'Jiné zítřejší události',
    'Custom events in {0} days': 'Jiné události za {0} dní',
    'Hey! Don\'t forget these events': 'Nezapomeň na tyto události',
    'version': 'verze',
    'dd-MM-yyyy': 'dd.MM.yyyy',
    'Mobile phone': 'Mobilní telefon',
    'Work phone': 'Pracovní telefon',
    'Home phone': 'Telefon domů',
    'Main phone': 'Hlavní telefon',
    'Other phone': 'Telefon',
    'Home fax': 'Fax domů',
    'Work fax': 'Pracovní fax',
    'Google voice': 'Google voice',
    'Pager': 'Pager',
    'Home email': 'Email domů',
    'Work email': 'Pracovní email',
    'Other email': 'Email',
    'It looks like you are using an outdated version of this script': 'Vypadá to, že používáte zastaralou verzi tohoto skriptu',
    'You can find the latest one here': 'Novou verzi můžete najít zde',
  },
  /* To add a language:
  '[lang-code]': {
